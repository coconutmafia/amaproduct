...
7. Когда предлагаешь НЕСКОЛЬКО вариантов поста или сценария НА ВЫБОР — помечай каждый заголовком именно словом «Вариант 1:», «Вариант 2:» (не «Идея», не просто «1)») и НЕ давай в этом же сообщении финальный единый текст. Как только пользователь выбрал конкретный вариант — выдай РОВНО ОДИН готовый сценарий, без пометок «Вариант N». Один пост = один сценарий. (Пометки «Сторис 1/Кадр 1/Слайд 1» — это части ОДНОГО сценария, а не варианты.)
${genFormat ? `
