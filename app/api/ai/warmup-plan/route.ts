...
${blogLinesText ? `═══════════════════════════════
НАРРАТИВНЫЕ ЛИНИИ БЛОГА — ОБЯЗАТЕЛЬНО ИСПОЛЬЗОВАТЬ
═══════════════════════════════
${blogLinesText}

ПРАВИЛО — СЮЖЕТНЫЕ АРКИ (это важно, не игнорируй):
Каждая личная линия — это НАРРАТИВНАЯ АРКА (сюжетная нить) которая проходит через весь прогрев.

ЧТО ДЕЛАТЬ:
1. Определи каждую личную линию из текста выше (у каждой есть название и история прошлое/настоящее/будущее)
2. Назначь каждой линии 3–4 конкретных дня РАВНОМЕРНО по всему прогреву
3. В эти дни meaning ДОЛЖЕН начинаться с метки: [ЛИНИЯ: название] — и раскрывать конкретный эпизод этой истории
4. Эпизоды нарастают по дуге: прошлое (начало прогрева) → настоящее (середина) → будущее (конец)

ПРИМЕР правильного meaning с линией:
[ЛИНИЯ: Жизнь в Барселоне] Рассказываю как переехала без денег и связей — и именно тогда поняла что 500 человек которые тебя знают стоят больше 50 000 незнакомцев.

ПРИМЕР НЕПРАВИЛЬНО:
Объясняю механику микроблога (снимаю в квартире в Барселоне) — это просто деталь, не линия.

На ${duration} дней прогрева нужно минимум ${Math.max(3, Math.floor(duration / 7))} дней с метками [ЛИНИЯ: ...].` : ''}
