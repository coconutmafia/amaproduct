...
${blogLinesText ? `═══════════════════════════════
ЛИЧНЫЕ ЛИНИИ БЛОГА (вплетай в смыслы дней)
═══════════════════════════════
${blogLinesText}

ПРАВИЛО: каждые 5–7 дней должен быть 1 день где meaning начинается с личной истории из линий блога и через неё раскрывает профессиональный смысл фазы.
Пример: "Рассказываю как [личная деталь] — и через это объясняю [суть фазы]."
НЕ создавай отдельную фазу — вплетай органично в существующие фазы.` : ''}
