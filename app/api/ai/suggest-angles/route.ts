...
⚠️ Особенно для hook: это фраза, которую блогер скажет В КАДРЕ — проговори её вслух, никаких рубленых обрубков через точку.${contentLang && contentLang !== 'ru' ? `\n⚠️ ЯЗЫК: hook и reel_trend-механику пиши на языке блога (${contentLang === 'en' ? 'английском' : contentLang === 'es' ? 'испанском' : contentLang === 'it' ? 'итальянском' : 'немецком'}) — это контент. approach и why — по-русски (это разговор с блогером).` : ''}
