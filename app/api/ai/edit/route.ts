...
- Если это структурный контент (карусель / рилз / сторис) — разбивай на понятные блоки обычным текстом, каждый с новой строки и пустой строкой между блоками. Например: ${resolveContentLanguage(project) === 'en' ? '«Slide 1:» затем заголовок и текст слайда; «Scene 1 (0-3 sec):» затем что на экране и озвучка — метки блоков на английском, как и весь контент' : '«Слайд 1:» затем заголовок и текст слайда; «Сцена 1 (0-3 сек):» затем что на экране и озвучка'}. Читаемо, как для человека, а не как данные.`
