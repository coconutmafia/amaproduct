...
-- Katia Ustina — испанский). До этой миграции язык генерации «плавал»: он выводился
-- из языка Tone of Voice («Язык ответа: тот, на котором написан TOV»), а материалы
-- у клиентов смешанные (кастдевы русские, блог английский) — язык контента прыгал.
--
...
alter table public.projects
  ...
  check (content_language in ('ru', 'en', 'es'));

comment on column public.projects.content_language is
  'Язык контента блога: ru/en/es. NULL = как раньше (язык TOV, иначе русский). Расширение списка — новая миграция.';
