...
const SLIDES = [
  ...
  },
  {
    ...
    tip: '🚀 Открой «Контент-план» в своём проекте и нажми «Сгенерировать план»',
  },
  {
    icon: Palette,
    ...
    tip: '🎨 Настрой «Фирменный стиль» в Материалах проекта — и весь визуал будет твой',
  },
  {
    icon: BarChart3,
    ...
    tip: '📊 Загрузи «Мой Instagram» и «Конкуренты» в Материалах — AI разберёт, что работает',
  },
]
