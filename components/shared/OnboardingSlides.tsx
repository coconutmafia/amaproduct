...
const SLIDES = [
  ...
  },
  {
    ...
    title: 'Приглашай — зарабатывай генерации',
    subtitle: 'Поделись сервисом с коллегами и получай бонусы',
    points: [
      'Твой реферал регистрируется → +10 генераций тебе',
      'Твой реферал оплачивает → +25 генераций тебе',
      '2-й уровень: если твой реферал кого-то пригласил — ты тоже получаешь',
    ],
    tip: '🔗 Твоя реферальная ссылка в разделе «Рефералы»',
  },
]
