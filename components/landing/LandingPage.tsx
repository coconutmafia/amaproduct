...
const ALL_PLANS = [
  {
    ...
    features: [
      ...
      { text: '100 единиц контента в месяц', ok: true },
  ...
  },
  {
    ...
    features: [
      { text: '1 проект (твой блог)', ok: true },
      { text: '300 единиц контента в месяц', ok: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '900 единиц контента в месяц — в 3 раза больше Соло', ok: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '1800 единиц контента в месяц', ok: true },
