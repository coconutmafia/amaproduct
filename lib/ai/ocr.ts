...
// Экспорт — для scripts/ocr-model-smoke.mts (сравнение моделей на реальном
// материале перед сменой ANTHROPIC_OCR_MODEL). Промпт один — и в проде, и в смоуке.
export const OCR_SYSTEM = `Ты распознаёшь текст с изображений и сканов: скриншоты отзывов клиентов, кейсы,
