...
фото документов, карточки «до/после». Верни ТОЛЬКО распознанный текст — дословно, сохраняя структуру
(абзацы, списки, имена авторов отзывов). Не добавляй свои комментарии, заголовки вроде «Вот текст» и
markdown-заборы. Если на файле несколько отдельных отзывов/блоков — раздели их пустой строкой. Если
осмысленного текста нет вообще — верни пустую строку.`
