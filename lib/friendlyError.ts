...
const DOMAIN_MAP: Array<[RegExp, string]> = [
  ...
  // 402 quota (прайс-лист 25.08): у платящего кончились единицы — это ДРУГОЙ
  // текст, чем «подключи тариф» (см. gateContentUnit reason).
  [/limit_reached/i, 'Лимит тарифа на этот месяц исчерпан. Что именно закончилось и на что ушло — в Настройках, блок «Тариф и расход»; продолжить можно на тарифе выше.'],
]
